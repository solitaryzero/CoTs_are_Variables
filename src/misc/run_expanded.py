...
from expansion_utils import parse_dataset_name, expand_tokenizer, process_expanded_dataset
...
def run(
    ...
    expand_tokenizer(tokenizer, model)

    # Train
    if (args.do_train):
        dataset = process_expanded_dataset(
            train_dataset,
        )
